...
export default function UpdateRecruiterByAdmin() {
    ...
    async function updateRecruiter(data) {
        const res = await adminServices.updateRecruiter(data)
        setSubmitting(false)
        if (res && res.success) {
    ...
    useEffect(() => {
        if (state) {
            ...
            // setFieldValue("companyLogo", state?.companyLogo)
            setUploadedImage(state?.companyLogo)
            setFieldValue("companyType", state?.companyType)
            setFieldValue("workEmail", state?.workEmail)
            setFieldValue("website", state?.website)
            setFieldValue("twitter", state?.twitter)
            setFieldValue("linkedIn", state?.linkedIn)
            setFieldValue("facebook", state?.facebook)
            setFieldValue("blogUrl", state?.blogUrl)
            setFieldValue("companySize", state?.companySize)
            setFieldValue("oneLinePitch", state?.oneLinePitch)
            setFieldValue("recruiterName", state?.recruiterName)
            setFieldValue("email", state?.email)
            setFieldValue("phone", state?.phone)
            setFieldValue("locations", state?.location)
            setFieldValue("markets", state?.markets)
            setFieldValue("isPremiumMember", state?.isPremiumMember)
        }
    }, [state])
